...
<%@ include file="/MainMember/main_top.jsp" %>	
	...
	<table width="800">
		...
		<tr>
			...
			<td width="450" align="left"><a href="qnaBoardView.jsp?num=<%=bean.getNum()%>"	style="text-decoration: none">  
 ...
 %> 		
		...
		%>
		<caption>
			<input class="button" type="button" value="글쓰기" onclick="location.href='qnaBoardInsert.jsp'">
		</caption>
	...
	<div id="pageNum">
			...
			%>
			<a href="qnaBoardList.jsp?pageNum=<%=i%>">[<%=i%>]
			</a>
			<%
				}
			}
